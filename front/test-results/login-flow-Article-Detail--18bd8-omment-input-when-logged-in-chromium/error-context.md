...
- Name: login-flow.spec.js >> Article Detail >> should display comment input when logged in
- Location: tests/e2e/login-flow.spec.js:267:7
...
- generic [active] [ref=e1]:
  - button "打开 AI 助手" [ref=e3]:
    - img [ref=e4]
  - generic [ref=e8]:
    - generic [ref=e9]: "[plugin:vite:vue] [vue/compiler-sfc] Unexpected token, expected \",\" (60:25) /workspace/front/src/components/frontend/FeaturedArticles.vue 150| const getApiBaseUrl = () => import.meta.env.VITE_API_BASE_URL || 'http://localhost:8080' 151| 152| const getAssetUrl = (path: string | undefined): string | undefined => { 153| if (!path) return path 154| if (path.startsWith('http://') || path.startsWith('https://')) return path"
    - generic [ref=e10]: /workspace/front/src/components/frontend/FeaturedArticles.vue:60:25
    - generic [ref=e11]: "29 | :class=\"{ 'animate-in': isVisible }\" 30 | :aria-label=\"`文章: ${article.title}`\" 31 | @click=\"$emit('articleClick', article.id)\" | ^ 32 | > 33 | <div class=\"card-image-wrapper\">"
    - generic [ref=e12]: at constructor (/workspace/front/node_modules/@babel/parser/lib/index.js:365:19) at Parser.raise (/workspace/front/node_modules/@babel/parser/lib/index.js:6599:19) at Parser.unexpected (/workspace/front/node_modules/@babel/parser/lib/index.js:6619:16) at Parser.expect (/workspace/front/node_modules/@babel/parser/lib/index.js:6899:12) at Parser.parseParenAndDistinguishExpression (/workspace/front/node_modules/@babel/parser/lib/index.js:11661:14) at Parser.parseExprAtom (/workspace/front/node_modules/@babel/parser/lib/index.js:11331:23) at Parser.parseExprSubscripts (/workspace/front/node_modules/@babel/parser/lib/index.js:11081:23) at Parser.parseUpdate (/workspace/front/node_modules/@babel/parser/lib/index.js:11066:21) at Parser.parseMaybeUnary (/workspace/front/node_modules/@babel/parser/lib/index.js:11046:23) at Parser.parseMaybeUnaryOrPrivate (/workspace/front/node_modules/@babel/parser/lib/index.js:10899:61)
    - generic [ref=e13]:
