...
- Name: comment-system.spec.js >> 评论系统 E2E 测试 >> 登录用户应该能看到评论输入框
- Location: tests/e2e/comment-system.spec.js:44:7
...
```ts
  ...
  2   | 
  3   | const TEST_USERNAME = 'admin'
  4   | const TEST_PASSWORD = '147258369Thy@'
  5   | 
