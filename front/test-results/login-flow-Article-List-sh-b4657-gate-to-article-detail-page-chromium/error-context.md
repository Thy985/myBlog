...
- Name: login-flow.spec.js >> Article List >> should navigate to article detail page
- Location: tests/e2e/login-flow.spec.js:211:7
...
- generic [active] [ref=e1]:
  - button "打开 AI 助手" [ref=e3]:
    - img [ref=e4]
  - generic [ref=e8]:
    - generic [ref=e9]: "[plugin:vite:vue] [vue/compiler-sfc] Unexpected token, expected \",\" (5:8) /workspace/front/src/components/layout/UserMenu.vue 100| avatar?: string"
    - generic [ref=e10]: /workspace/front/src/components/layout/UserMenu.vue:5:8
    - generic [ref=e11]: 3 | <button 4 | id="user-menu-button" 5 | type="button" | ^ 6 | class="flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-300 hover:bg-primary-subtle focus:o... 7 | :aria-expanded="isOpen"
