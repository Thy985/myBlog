    ...
    <el-card shadow="never" :body-style="{ padding: '20px' }">
        <el-form :model="form" label-width="160px" :rules="rules">
            ...
            <el-form-item label="作者头像" prop="avatar">
                <el-upload
class="avatar-uploader" action="#" :on-change="handleTitleImageChange" :auto-upload="false"
                    :show-file-list="false" :on-success="handleAvatarSuccess">
                    <img v-if="form.avatar" :src="form.avatar" class="avatar" loading="lazy" @error="(e) => e.target.style.display='none'" />
            ...
            <el-form-item v-if="isGithubCheck" label="GitHub 主页访问地址">
            ...
            <el-form-item v-if="isCSDNCheck" label="CSDN 主页访问地址">
            ...
            <el-form-item v-if="isGiteeCheck" label="Gitee 主页访问地址">
            ...
            <el-form-item v-if="isZhihuCheck" label="知乎主页访问地址">
